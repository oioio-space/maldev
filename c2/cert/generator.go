...
// Config contains the configuration for certificate generation.
type Config struct {
	Organization string
	CommonName   string
	ValidDays    int
...
// writing them to certPath and keyPath in PEM format.
...
// Fingerprint computes a hex-encoded representation of a PEM certificate file.
