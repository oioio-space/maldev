...
| T1003.001 | OS Credential Dumping: LSASS Memory | `credentials/lsassdump` (producer — dump + PPL unprotect), `credentials/sekurlsa` (consumer — pure-Go MSV1_0 parser) | D3-PSA (Process Spawn Analysis), D3-SICA (System Image Change Analysis) |
