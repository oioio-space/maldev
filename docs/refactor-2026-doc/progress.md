...
| 3b — gh-pages mdBook deploy | ✅ done | `<this-commit>` | `book.toml` + `docs/SUMMARY.md` + `.github/workflows/mdbook.yml` shipped. CI installs mdBook 0.4.40 + mdbook-mermaid 0.14.0 on push to `master`, strips YAML front-matter from copied md, rewrites `../README.md` → absolute GitHub URL, and deploys to GitHub Pages. **Repo setting** required once: Settings → Pages → Source: GitHub Actions. |
