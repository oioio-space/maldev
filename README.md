...
| **C2** | `c2/shell/` `c2/transport/` `c2/multicat/` `c2/meterpreter/` `c2/cert/` | Reverse shell with PTY (Linux) + reconnect, multi-session listener (operator-side), Meterpreter staging (TCP/HTTP/HTTPS), TLS with JA3 fingerprinting, malleable C2, PPID spoofing |
...
| **[C2 & Transport](docs/techniques/c2/README.md)** | [Reverse Shell](docs/techniques/c2/reverse-shell.md) · [Meterpreter](docs/techniques/c2/meterpreter.md) · [Transport](docs/techniques/c2/transport.md) · [Malleable HTTP](docs/techniques/c2/malleable-profiles.md) · Multi-session listener (`c2/multicat`) |
