...
| **Evasion** | `evasion/amsi/` `etw/` `unhook/` `sleepmask/` `hwbp/` `acg/` `blockdlls/` `antidebug/` `antivm/` `sandbox/` `timing/` `herpaderping/` `phant0m/` `fakecmd/` | AMSI/ETW patching, ntdll unhooking (Classic/Full/Perun), sleep encryption, HW breakpoint detection, Herpaderping, PEB CommandLine spoofing |
...
| **[PE Operations](docs/techniques/pe/README.md)** | [Strip & Sanitize](docs/techniques/pe/strip-sanitize.md) · [BOF Loader](docs/techniques/pe/bof-loader.md) · [Morph](docs/techniques/pe/morph.md) · [PE-to-Shellcode](docs/techniques/pe/pe-to-shellcode.md) · [Certificate Theft](docs/techniques/pe/certificate-theft.md) |
...
├── evasion/herpaderping/  evasion/phant0m/  evasion/fakecmd/
